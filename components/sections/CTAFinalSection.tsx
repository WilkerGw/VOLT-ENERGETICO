...
export function CTAFinalSection() {
  return (
    <section aria-labelledby="cta-final-heading" className="relative flex min-h-screen items-center justify-center overflow-hidden px-6 py-24 text-center md:px-12">
      ...
      <div className="relative z-10 mx-auto max-w-5xl">
        <SplitHeadline
          ...
          className="mx-auto mb-12 max-w-2xl font-display text-2xl font-extrabold leading-[0.94] text-black sm:text-5xl md:text-[2.6rem]"
        />
